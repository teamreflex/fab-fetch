...
export const login = async (): Promise<AuthResult> => {
  ...
  console.info(chalk.green(`Logged in as user:`, chalk.cyan.bold(data.login.user.nickName)))
  console.info(chalk.green(`Points available:`, chalk.cyan.bold(data.login.user.points)))
...
export const userInfo = async (): Promise<User> => {
  ...
  console.info(chalk.green(`Fetched user:`, chalk.cyan.bold(data.user.nickName)))
  console.info(chalk.green(`Points available:`, chalk.cyan.bold(data.user.points)))
